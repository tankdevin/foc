 ...
 */
class Interval extends BasicAdmin
{
     ...
     * @var string
     */
    public $table = 'store_order_interval';
    ...
    public function index()
    {
        ...
        // 日志数据库对象
        list($this->title, $get) = ['买卖设置', $this->request->get()];
    ...
    public function del()
    {
        if (DataService::update($this->table)) {
            $this->success("买卖设置删除成功!", '');
        }
        $this->error("买卖设置删除失败, 请稍候再试!");
    }
