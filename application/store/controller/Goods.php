...
class Goods extends BasicAdmin
{
    ...
    public function add()
    {
        ...
        try {
            ...
            //最简单的方式是用到了事物，当闭包中的代码发生了异常的话，会进行回滚
    ...
    protected function _form_build_data()
    {
        ...
        $main['package_stock'] = $this->request->post('package_stock', '');
        $main['goods_image'] = $this->request->post('goods_image', '');
        $main['goods_day'] = $this->request->post('goods_day', '');
        $main['goods_sy_rate'] = $this->request->post('goods_sy_rate', '');
