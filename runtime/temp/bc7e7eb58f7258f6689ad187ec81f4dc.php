<?php /*a:2:{s:64:"D:\workspaces\www.ntf.com\application\admin\view\menu\index.html";i:1595314212;s:68:"D:\workspaces\www.ntf.com\application\admin\view\public\content.html";i:1595314206;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<button data-modal='<?php echo url("$classuri/add"); ?>' data-title="添加菜单" class='layui-btn layui-btn-sm layui-btn-primary'>添加菜单</button>
<!--<?php endif; ?>-->
<!--<?php if(auth("$classuri/del")): ?>-->
<button data-update data-field='delete' data-action='<?php echo url("$classuri/del"); ?>' class='layui-btn layui-btn-sm layui-btn-primary'>删除菜单</button>
<!--<?php endif; ?>-->
</div>
    </div>
    <!--<?php endif; ?>-->
    ...
    <table id="test" class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <td class='text-center nowrap notselect'>
                ...
                <!--<?php if($vo['spt']<2): ?>-->
                <a data-title="添加菜单" data-modal='<?php echo url("$classuri/add"); ?>?pid=<?php echo htmlentities($vo['id']); ?>'>添加下级</a>
                <!--<?php else: ?>-->
                <a class="color-desc">添加下级</a>
                <!--<?php endif; ?>-->
                <?php endif; if(auth("$classuri/edit")): ?>
                <span class="text-explode">|</span>
                <a data-title="编辑菜单" data-modal='<?php echo url("$classuri/edit"); ?>?id=<?php echo htmlentities($vo['id']); ?>'>编辑</a>
